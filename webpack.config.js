/**
 * This file was created following this guide: https://blog.bitsrc.io/build-a-website-with-modern-tooling-and-no-frameworks-a33e65099f9
 * I have added comments with the "MODIFICATION:" prefix to indicate where and why I have deviated from the guide.
 * Basically, I wanted Typescript and the guide was using Javascript.
 */
...
module.exports = {
  ...
  resolve: { // MODIFICATION: Not totally sure if we need this, but the Webpack TS docs said to do this.
    extensions: ['.ts', '.js'],
  },
  plugins: [
